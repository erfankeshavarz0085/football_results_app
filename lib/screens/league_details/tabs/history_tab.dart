...
class _HistoryTabState extends State<HistoryTab> {
  ...
  Widget build(BuildContext context) {
    final champions = LeagueHistoryData.championsFor(widget.leagueId);

    if (champions.isEmpty) {
      return _emptyState();
    }

    final filteredChampions = selectedSeason == null
        ? champions
  ...
  Widget _emptyState() {
    return const Center(
      child: Padding(
        ...
        child: Text(
          'Champions history is not available for this league yet.',
          textAlign: TextAlign.center,
